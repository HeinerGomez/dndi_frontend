...
export class ModalService {
	...
	constructor(private _modal: NgbModal, private _modalData: ModalDataService) {}
	...
	watchData = () => this.subject.asObservable();

	emitData = (data: any) => this.subject.next(data);

	resetEmitData = () => this.subject.next(null);
}
